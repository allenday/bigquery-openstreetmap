...
SELECT
  2725 AS layer_code, 'poi_tourism' AS layer_class, 'art' AS layer_name, f.feature_type AS gdal_type, f.osm_id, f.osm_way_id, f.osm_timestamp, osm.all_tags, f.geometry
FROM
