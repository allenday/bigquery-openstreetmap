...
SELECT 2030 AS layer_code, 'poi_public' AS layer_class, 'recycling' AS layer_name, f.feature_type AS gdal_type, f.osm_id, f.osm_way_id, f.osm_timestamp, osm.all_tags, f.geometry
