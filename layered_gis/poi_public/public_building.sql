SELECT
  2099 AS layer_code, 'poi_public' AS layer_class, 'public_building' AS layer_name, feature_type AS gdal_type, osm_id, osm_way_id, osm_timestamp, all_tags, geometry
