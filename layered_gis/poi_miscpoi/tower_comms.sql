...
SELECT 2951 AS layer_code, 'poi_miscpoi' AS layer_class, 'tower_comms' AS layer_name, f.feature_type AS gdal_type, f.osm_id, f.osm_way_id, f.osm_timestamp, osm.all_tags, f.geometry
