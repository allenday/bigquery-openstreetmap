...
SELECT 1005 AS layer_code, 'place' AS layer_class, 'national_capital' AS layer_name, f.feature_type AS gdal_type, f.osm_id, f.osm_way_id, f.osm_timestamp, osm.all_tags, f.geometry
