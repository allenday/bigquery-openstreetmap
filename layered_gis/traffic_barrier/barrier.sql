...
UNION ALL
SELECT
  5210 AS layer_code, 'traffic' AS layer_class, 'barrier' AS layer_name, f.feature_type AS gdal_type, f.osm_id, f.osm_way_id, f.osm_timestamp, osm.all_tags, f.geometry
FROM
  `openstreetmap-public-data-dev.osm_planet.features` AS f, osm
