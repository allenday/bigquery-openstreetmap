...
do
  ...
  V="${KV##*=}"
  echo "SELECT
  $CODE AS layer_code, 'poi_shopping' AS layer_class, '$V' AS layer_name, feature_type AS gdal_type, osm_id, osm_version, osm_timestamp, all_tags, geometry
...
#2518
echo "SELECT
  2518 AS layer_code, 'poi_shopping' AS layer_class, 'beverages' AS layer_name, feature_type AS gdal_type, osm_id, osm_version, osm_timestamp, all_tags, geometry
FROM \`${GCP_PROJECT}.${BQ_DATASET}.features\`
...
echo "SELECT
  2543 AS layer_code, 'poi_shopping' AS layer_class, 'doityourself' AS layer_name, feature_type AS gdal_type, osm_id, osm_version, osm_timestamp, all_tags, geometry
FROM \`${GCP_PROJECT}.${BQ_DATASET}.features\`
...
#2568
echo "SELECT
  2568 AS layer_code, 'poi_shopping' AS layer_class, 'laundry' AS layer_name, feature_type AS gdal_type, osm_id, osm_version, osm_timestamp, all_tags, geometry
FROM \`${GCP_PROJECT}.${BQ_DATASET}.features\`
...
#2590
echo "SELECT
  2590 AS layer_code, 'poi_shopping' AS layer_class, 'vending_cigarette' AS layer_name, feature_type AS gdal_type, osm_id, osm_version, osm_timestamp, all_tags, geometry
FROM \`${GCP_PROJECT}.${BQ_DATASET}.features\`
...
#2591
echo "SELECT
  2591 AS layer_code, 'poi_shopping' AS layer_class, 'vending_cigarette' AS layer_name, feature_type AS gdal_type, osm_id, osm_version, osm_timestamp, all_tags, geometry
FROM \`${GCP_PROJECT}.${BQ_DATASET}.features\`
...
#2592
echo "SELECT
  2592 AS layer_code, 'poi_shopping' AS layer_class, 'vending_parking' AS layer_name, feature_type AS gdal_type, osm_id, osm_version, osm_timestamp, all_tags, geometry
FROM \`${GCP_PROJECT}.${BQ_DATASET}.features\`
