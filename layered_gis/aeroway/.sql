...
SELECT 6702 AS layer_code, 'aeroway' AS layer_class, '' AS layer_name, f.feature_type AS gdal_type, f.osm_id, f.osm_way_id, f.osm_timestamp, osm.all_tags, f.geometry
