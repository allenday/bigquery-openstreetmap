...
SELECT 2255 AS layer_code, 'poi_leisure' AS layer_class, 'golf_course' AS layer_name, f.feature_type AS gdal_type, f.osm_id, f.osm_way_id, f.osm_timestamp, osm.all_tags, f.geometry
