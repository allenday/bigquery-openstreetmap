...
SELECT 2950 AS layer_code, 'poi_leisure' AS layer_class, 'swimming_pool' AS layer_name, f.feature_type AS gdal_type, f.osm_id, f.osm_way_id, f.osm_timestamp, osm.all_tags, f.geometry
