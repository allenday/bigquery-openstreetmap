...
SELECT
  2403 AS layer_code, 'poi_accommodation' AS layer_class, 'bed_and_breakfast' AS layer_name, f.feature_type AS gdal_type, f.osm_id, f.osm_way_id, f.osm_timestamp, osm.all_tags, f.geometry
FROM
