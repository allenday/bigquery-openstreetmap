...
SELECT 7217 AS layer_code, 'land_use' AS layer_class, 'scrub' AS layer_name, f.feature_type AS gdal_type, f.osm_id, f.osm_way_id, f.osm_timestamp, osm.all_tags, f.geometry
